            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{ asset('img/costic/pizza.jpg') }}" alt="people"> Pizza </td>
                      <td>$19.99</td>
                      <td>67384917</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{ asset('img/costic/french-fries.jpg') }}" alt="people"> French Fries </td>
                      <td>$14.59</td>
                      <td>789393819</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{ asset('img/costic/cereals.jpg') }}" alt="people"> Multigrain Hot Cereal </td>
                      <td>$25.22</td>
                      <td>137893137</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{ asset('img/costic/egg-sandwich.jpg') }}" alt="people"> Fried Egg Sandwich </td>
                      <td>$11.23</td>
                      <td>235193138</td>
                    </tr>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="ms-card no-margin">
                    <div class="ms-card-body">
                      <div class="media fs-14">
                        <div class="mr-2 align-self-center">
                          <img src="{{ asset('img/costic/customer-6.jpg') }}" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                          <h6>Delizious </h6>
                          <div class="dropdown float-right">
              ...
              <ul class="ms-list ms-feed ms-twitter-feed ms-recent-support-tickets">
                <li class="ms-list-item">
                  <a href="#" class="media clearfix">
                    <img src="{{ asset('img/costic/customer-4.jpg') }}" class="ms-img-round ms-img-small" alt="This is another feature">
                    <div class="media-body">
                      <div class="d-flex justify-content-between">
                ...
                <li class="ms-list-item">
                  <a href="#" class="media clearfix">
                    <img src="{{ asset('img/costic/customer-1.jpg') }}" class="ms-img-round ms-img-small" alt="This is another feature">
                    <div class="media-body">
                      <div class="d-flex justify-content-between">
                        <h6 class="ms-feed-user mb-0">Lorem ipsum dolor</h6>
                        <span class="badge badge-success"> Open </span>
                ...
                <li class="ms-list-item">
                  <a href="#" class="media clearfix">
                    <img src="{{ asset('img/costic/customer-7.jpg') }}" class="ms-img-round ms-img-small" alt="This is another feature">
                    <div class="media-body">
                      <div class="d-flex justify-content-between">
                        <h6 class="ms-feed-user mb-0">Lorem ipsum dolor</h6>
